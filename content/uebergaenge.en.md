...
[[extra.sections]]
title = "Work Without Fear"
text = "Upskilling and career changes must become normal: fewer hurdles, more support, clear prospects. Those who adapt deserve a safety net — not a bureaucratic maze."

[[extra.sections]]
title = "What Must Change"
text = ""
subsections = [
  { title = "Fewer Bureaucratic Hurdles", text = "Retraining shouldn't be an obstacle course. Applications must be simpler, approvals faster and funding more accessible." },
  { title = "Better Recognition of Skills and Certificates", text = "Work experience and further training count — even when they don't come from the traditional education system. Competence over diplomas." },
  { title = "Combining Learning and Work", text = "Part-time models, work-integrated education and modular training must be promoted — for all life stages, not just career starters." },
  { title = "Focus: Results, Not Forms", text = "Less administration, more impact. Support programmes should be measured by outcomes, not by the number of forms filled in." },
]

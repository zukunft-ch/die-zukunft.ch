+++
title = "Calculateur RBI"
description = "Combien coûte un revenu de base — et comment le financer ? Réglez les paramètres et voyez les résultats en temps réel."
template = "ubi-rechner.html"
slug = "calculateur-rbi"

[extra]
show_cta = true
cta_text = "Convaincu·e ? Engagez-vous avec nous pour un revenu de base."
cta_grundeinkommen_text = "En savoir plus sur le revenu de base"

hero_title = "Calculateur RBI"
hero_desc = "Combien coûte un revenu de base inconditionnel pour la Suisse — et comment le financer ? Réglez les paramètres et comparez les scénarios."

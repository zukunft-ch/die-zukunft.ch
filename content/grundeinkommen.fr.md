...
[extra]
show_cta = true
cta_text = "Convaincu·e ? Engage-toi avec nous pour un revenu de base."
...
faq = [
  ...
  { q = "Comment est-il financé ?", a = "Pas par une taxe spéciale sur les robots — automatiser n'est pas puni. Le financement passe par l'imposition normale d'une création de valeur croissante (revenu, consommation, fortune), par les gains de simplification du système social et par la réaffectation de transferts existants — précisément les leviers que modélise notre calculateur RBI. Des modèles concrets sont élaborés avec des économistes et des spécialistes des sciences sociales." },
...
sim_desc = "Combien coûte un revenu de base inconditionnel pour la Suisse — et comment le financer ? Règle les paramètres et compare les scénarios."

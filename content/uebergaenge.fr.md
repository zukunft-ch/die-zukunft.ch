...
[[extra.sections]]
title = "Travailler sans peur"
text = "La formation continue et le changement de métier doivent devenir la norme : moins d'obstacles, plus de soutien, des perspectives claires. Qui se réoriente mérite un filet – pas un labyrinthe administratif."

[[extra.sections]]
title = "Ce qui doit changer"
text = ""
subsections = [
  { title = "Moins de barrières bureaucratiques", text = "La reconversion ne doit pas être un parcours du combattant. Les demandes doivent être plus simples, les autorisations plus rapides et les aides plus accessibles." },
  { title = "Meilleure reconnaissance des compétences et certifications", text = "L'expérience professionnelle et les formations continues comptent – même si elles ne viennent pas du système éducatif classique. La compétence avant le diplôme." },
  { title = "Combiner apprentissage et travail", text = "Les modèles à temps partiel, la formation continue en cours d'emploi et les formations modulaires doivent être encouragés – pour toutes les phases de la vie, pas seulement pour les débutants." },
  { title = "Focus : résultats plutôt que formulaires", text = "Moins d'administration, plus d'impact. Les programmes de soutien doivent être mesurés à leurs résultats, pas au nombre de formulaires remplis." },
]

+++
title = "Votations"
description = "Votations populaires fédérales — aperçu des objets, mis en perspective le long des douze piliers de Le Futur. Sans consigne de vote, avec une perspective de programme."
template = "page.html"
+++
...
## Pourquoi ce tracker existe

Les votations fédérales sont le principal instrument de pilotage de la Suisse. Elles s'enchaînent à un rythme dense — quatre dates par an, souvent deux à cinq objets par date. Qui ne suit pas la politique à plein temps perd vite la vue d'ensemble.

Cette page est notre contribution à l'attention civile : une mise en perspective compacte par objet, toujours le long des mêmes douze piliers. Sans consigne de vote. Qui veut lire le texte complet et les arguments officiels trouve tout sur [admin.ch](https://www.admin.ch/) et chez [easyvote.ch](https://www.easyvote.ch/).

+++
title = "Robotica e reindustrializzazione"
slug = "robotica"
description = "Più produzione e valore aggiunto in Svizzera – moderna, automatizzata, a misura di PMI."
template = "page.html"
...
text = "Se vogliamo riportare la produzione, deve essere moderna: automatizzata, efficiente, resiliente. È un'opportunità – soprattutto per le PMI."

[[extra.sections]]
title = "Le nostre priorità"
text = ""
items = [
  { label = "Salute e approvvigionamento scienze della vita", text = "Medtech, produzione vicina al farmaceutico" },
  { label = "Nucleo industriale", text = "Precisione, costruzione di utensili, elettronica/packaging" },
  { label = "Basi di resilienza", text = "Food/Agri-Tech, sicurezza delle reti e dell'approvvigionamento" },
]

[[extra.sections]]
title = "Il pacchetto PMI"
text = "Il finanziamento prima di tutto: crediti agevolati, garanzie, co-investimenti per la modernizzazione e la rilocalizzazione."
points = [
  "Incentivi fiscali per investimenti in automazione",
  "Laboratori di robotica condivisi / centri di automazione",
  "Buoni per formazione e perfezionamento",
  "Procedure accelerate per siti di produzione moderni",
  "Vantaggi negli acquisti per beni critici (dove appropriato)",
  "Sandbox regolamentari per l'automazione",
]

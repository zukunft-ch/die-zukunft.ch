+++
title = "UBI-Rechner"
description = "Was kostet ein Grundeinkommen — und wie lässt es sich finanzieren? Stell die Parameter selbst ein und sieh die Ergebnisse in Echtzeit."
template = "ubi-rechner.html"

[extra]
show_cta = true
cta_text = "Überzeugt? Setz dich mit uns für ein Grundeinkommen ein."
cta_grundeinkommen_text = "Mehr über Grundeinkommen"

hero_title = "UBI-Rechner"
hero_desc = "Was kostet ein bedingungsloses Grundeinkommen für die Schweiz — und wie lässt es sich finanzieren? Stell die Parameter ein und vergleiche Szenarien."

...
[[extra.sections]]
title = "Arbeit ohne Angst"
text = "Weiterbildung und Berufswechsel müssen normal werden: weniger Hürden, mehr Unterstützung, klare Perspektiven. Wer sich verändert, verdient ein Netz – kein Formular-Labyrinth."

[[extra.sections]]
title = "Was sich ändern muss"
text = ""
subsections = [
  { title = "Weniger bürokratische Hürden", text = "Umschulung darf kein Spiessrutenlauf sein. Anträge müssen einfacher, Bewilligungen schneller und Förderung zugänglicher werden." },
  { title = "Bessere Anerkennung von Skills und Zertifikaten", text = "Berufserfahrung und Weiterbildungen zählen – auch wenn sie nicht aus dem klassischen Bildungssystem kommen. Kompetenz vor Diplom." },
  { title = "Lernen und Arbeit kombinieren", text = "Teilzeitmodelle, berufsbegleitende Weiterbildung und modulare Ausbildungen müssen gefördert werden – für alle Lebensphasen, nicht nur für Berufseinsteiger." },
  { title = "Fokus: Resultate statt Formulare", text = "Weniger Verwaltung, mehr Wirkung. Förderprogramme sollen an Ergebnissen gemessen werden, nicht an der Anzahl ausgefüllter Formulare." },
]

[[extra.sections]]
title = "Warum das dringend ist"
text = ""
points = [

...
text = "La formazione continua e il cambio di professione devono diventare la norma: meno ostacoli, più sostegno, prospettive chiare. Chi si riorienta merita una rete – non un labirinto burocratico."

[[extra.sections]]
title = "Cosa deve cambiare"
text = ""
subsections = [
  { title = "Meno barriere burocratiche", text = "La riqualificazione non deve essere un percorso a ostacoli. Le domande devono essere più semplici, le autorizzazioni più rapide e i sostegni più accessibili." },
  { title = "Migliore riconoscimento delle competenze e certificazioni", text = "L'esperienza professionale e la formazione continua contano – anche se non provengono dal sistema educativo classico. La competenza prima del diploma." },
  { title = "Combinare apprendimento e lavoro", text = "I modelli a tempo parziale, la formazione continua durante l'impiego e le formazioni modulari devono essere incoraggiati – per tutte le fasi della vita, non solo per chi entra nel mondo del lavoro." },
  { title = "Focus: risultati invece di formulari", text = "Meno amministrazione, più impatto. I programmi di sostegno devono essere misurati dai risultati, non dal numero di formulari compilati." },
]

[[extra.sections]]
title = "Perché è urgente"
text = ""
points = [

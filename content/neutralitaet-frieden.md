...
description = "Die Schweiz bleibt neutral, souverän und glaubwürdig – und wird wieder ein Ort, an dem Frieden verhandelt wird."
template = "page.html"
...
[[extra.sections]]
title = "Was Neutralität für uns heisst"
text = ""
points = [
  "Keine Beteiligung an Kriegen zwischen Staaten",
  "Keine offensiven Militärabenteuer",
  "Aktive Friedensarbeit: vermitteln, hosten, humanitär unterstützen",
]

[[extra.sections]]
title = "Warum ein Schutz- und Resilienz-Fokus Sinn macht"
text = "Die Bedrohungen haben sich verändert: hybride Risiken, Sabotage, Cyberangriffe, Systemausfälle. Kritische Infrastruktur ist das Nervensystem der modernen Schweiz. Darum: Schutzfähigkeit ausbauen, ohne aggressiv zu werden:"
points = [
  "Kritische Infrastruktur schützen (IT/OT, Energie, Kommunikation, Versorgung)",
  "Zivile Behörden bei Krisen unterstützen",
  "Klare, defensive Doktrin",
  "Hohe Professionalität und demokratische Kontrolle",
]

[[extra.sections]]
title = "Schweiz als Gastgeberin und Ermöglicherin für Frieden"
text = "Wir wollen die Rolle der Schweiz als Gastgeberin für Gespräche, Verhandlungen und Abkommen stärken – mit International Geneva als Plattform, und mit einer konsequenten Politik der Good Offices."

[[extra.sections]]
title = "Leitplanken"
text = ""
points = [
  "Strikt defensiv: Schutz statt Projektion",
  "Neutral und glaubwürdig: keine Lagerlogik",
  "Transparent und rechtsstaatlich: klare Mandate, klare Verantwortungen",
]
+++
